        ...
        if (empty($err)) {
            ...
            if ($ru == false) {
                ...
                try {
                    ...
                    $ri->execute([$nomprod, $des, $prix, $qte, $uploadDir . $imgName, $idbou, $cat]);
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="upload-box text-center">
                            ...
                            <h5 class="mt-3">Glissez votre image ici</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="nomprod" placeholder="Nom du produit" type="text" value="<?= isset($nomprod) ? $nomprod : '' ?>" />
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="prix" placeholder="0.00" type="number" step="0.01" value="<?= isset($prix) ? $prix : '' ?>" />
                    </div>

                    <div class="col-md-4">
                        <?php if (isset($err['qte'])) echo "<div class='text-danger small mt-1'>" . $err['qte'] . "</div>" ?>
                        <label class="form-label">Quantité stock</label>
                        <input class="form-control" name="qte" placeholder="0" type="number" value="<?= isset($qte) ? $qte : '' ?>" />
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" name="des" placeholder="Description du produit..."><?= isset($des) ? $des : '' ?></textarea>
                    </div>
